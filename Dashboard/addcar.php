...
if(isset($_POST['add'])){
    ...
    $query = "INSERT into cars(mid,year,kms,con,variant,price) values('$carid','$year','$km','$condition','$variant','$price')";
...
<div class="jumbotron mx-auto">
    ...
    <?php foreach($models as $model) : ?>
        <option value="<?php echo $model['mid'] ?>"><?php echo $model['brand'] . " - " . $model['model'] . " - " . $model['fuel'] ?></option>
    <?php endforeach; ?>
    </select><br>
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input class="form-control" type="text" name="km">
        </div>
        <div class="form-group col-md-6">
            <label>Price</label>
